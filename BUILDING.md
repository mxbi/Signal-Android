...
1. Checkout the mSignal project source with the command:

        git clone https://github.com/mxbi/Signal-Android.git
...
6. Paste the URL for the Signal-Android project when prompted (https://github.com/mxbi/Signal-Android.git).
